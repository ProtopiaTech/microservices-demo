...
7. **Checkpoint — stop.** Report the research, scope, and task tier, then **end the turn and wait
   for the user's explicit approval**. `work-tests` (Step 2, consumes `1-research.md`) starts only
   after they approve — never in the same turn.
